...
use Voyelle\NotificationsCenter\Core\Field;
    ...
    class Settings {
        ...
        function update_settings() {
            ...
            foreach( $fields as $field_id => $field_data ) {
                $field_obj = new Field( $field_data );
        ...
        public function settings_screens( $screens ) {
            ...
            $screens['defaults'] = array(
                ...
                'callback' => array( Settings::class, 'settings_defaults_screen' )
            );
            $screens['general'] = array(
                'title' => __( 'Settings', 'notifications-center' ),
                'callback' => array( Settings::class, 'settings_general_screen' )
            );
            $screens['template'] = array(
                'title' => __( 'Template', 'notifications-center' ),
                'url' => TemplateCustomizer::customizer_url(),
            );
            return $screens;
        }
        ...
        private static function get_current_screen_id() {
            $screens = voynotif_get_settings_screens();
            if( empty( $_GET[Settings::SCREEN_VAR] ) ) {
