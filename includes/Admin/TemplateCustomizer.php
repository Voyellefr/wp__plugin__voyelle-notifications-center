...
namespace Voyelle\NotificationsCenter\Admin;

use Voyelle\NotificationsCenter\Core\EmailTemplate;
 ...
 * @since 0.9
 */
if( !class_exists( TemplateCustomizer::class , false ) ) {
    class TemplateCustomizer {
        ...
        public function __construct() {
            ...
            add_action( 'customize_register', __NAMESPACE__ . '\\voynotif_custmizer_register_controls', 10);
        ...
        function template_preview_html() {
            ...
            if ( get_query_var( $this->_trigger ) ) {
                $template_obj = new EmailTemplate();
...
function voynotif_custmizer_register_controls() {
    ...
    class CustomizeTextareaControl extends \WP_Customize_Control {
