...
namespace Voyelle\NotificationsCenter\Notifications\WooCommerce;

use Voyelle\NotificationsCenter\Compat\WooCommerce;
 ...
 * 
 */
class NewOrder extends NotificationType {
    ...
    function custom_masks($masks) {
        ...
        //unset $masks['id'];
        $wc_masks = WooCommerce::get_masks();
